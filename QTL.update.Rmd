...
bedtools intersect -a psychENCODE.mergedGenotype.RRP.190sample.commonSet.vcf.gz -b teqtl.fdr05.kozak.upstream.uniq.bed -wa -wb | bgzip > kozak.upstream.results.teqtl.fdr05.nohead.vcf.gz
bedtools intersect -a psychENCODE.mergedGenotype.RRP.190sample.commonSet.vcf.gz -b non.teqtl.fdr05.kozak.upstream.uniq.bed -wa -wb | bgzip > kozak.upstream.results.nonteqtl.fdr05.nohead.vcf.gz

bedtools intersect -a psychENCODE.mergedGenotype.RRP.190sample.commonSet.vcf.gz -b teqtl.fdr05.kozak.downstream.uniq.bed -wa -wb | bgzip > kozak.downstream.results.teqtl.fdr05.nohead.vcf.gz
bedtools intersect -a psychENCODE.mergedGenotype.RRP.190sample.commonSet.vcf.gz -b non.teqtl.fdr05.kozak.downstream.uniq.bed -wa -wb | bgzip > kozak.downstream.results.nonteqtl.fdr05.nohead.vcf.gz

# Extract hits
zcat kozak.upstream.results.nonteqtl.fdr05.nohead.vcf.gz | awk '{print $(NF-2)}' | sort | uniq -c > kozak.upstream.results.nonteqtl.fdr05.counted
zcat kozak.upstream.results.teqtl.fdr05.nohead.vcf.gz | awk '{print $(NF-2)}' | sort | uniq -c > kozak.upstream.results.teqtl.fdr05.counted

zcat kozak.downstream.results.nonteqtl.fdr05.nohead.vcf.gz | awk '{print $(NF-2)}' | sort | uniq -c > kozak.downstream.results.nonteqtl.fdr05.counted
zcat kozak.downstream.results.teqtl.fdr05.nohead.vcf.gz | awk '{print $(NF-2)}' | sort | uniq -c > kozak.downstream.results.teqtl.fdr05.counted
