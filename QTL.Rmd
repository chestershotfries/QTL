...
cut -f 4 hg19.exons.geneid.sorted.bed | uniq | while read C
do
     awk -v C=${C} '($4==C)' hg19.exons.geneid.sorted.bed | sort -t $'\t' -k1,1 -k2,2n | bedtools merge -c 4,5,6 -o distinct -s >> hg19.exons.merged.bed
done
