...
cut -f 4 hg19.exons.geneid.bed | while read C
do
     awk -v C=${C} '($4==C)' hg19.exons.geneid.bed | sort -k1,1 -k2,2n | bedtools merge -c 4,5,6 -o distinct -s >> hg19.exons.merged.bed
done
...
do
     awk -v C=${C} '($4==C)' hg19.introns.geneid.bed | sort -k1,1 -k2,2n | bedtools merge -c 4,5,6 -o distinct -s >> hg19.introns.merged.bed
done
#Split into teQTL and non-teQTL
grep -f teqtl.fdr10.names introns.uniq.sorted.bed > teqtl.fdr10.introns.bed
grep -f non.teqtl.fdr10.names introns.uniq.sorted.bed > non.teqtl.fdr10.introns.bed
grep -f non.teqtl.fdr05.names introns.uniq.sorted.bed > non.teqtl.fdr05.introns.bed
grep -f non.teqtl.fdr01.names introns.uniq.sorted.bed > non.teqtl.fdr01.introns.bed
grep -f teqtl.fdr05.names introns.uniq.sorted.bed > teqtl.fdr05.introns.bed
grep -f teqtl.fdr01.names introns.uniq.sorted.bed > teqtl.fdr01.introns.bed
#Remove exons
